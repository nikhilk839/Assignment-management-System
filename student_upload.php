...
else 
{
    ...
    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], "assignment/" . $newfilename))
    {
        ...
        $sql="INSERT INTO `assignment`(`subject_id`, `assignment_name`, `date_time`) VALUES ('$subject_id','$withoutExt','$date')";
        mysqli_query($conn,$sql);
        echo $newfilename;
        

        $q ='CREATE TABLE '.$withoutExt.' (student_id VARCHAR(50), assignment_name VARCHAR(100), marks INT);';
        mysqli_query($conn, $q);
